...
class SpecEI:
    ...
    def _surrogate(self, x_train: NDArray[np.float_]) -> Tuple[Tuple[NDArray[np.float_], NDArray[np.float_]], Tuple[NDArray[np.float_], NDArray[np.float_]]]:
    ...
    def pcc(self, var_1: NDArray[np.float_], var_2:NDArray[np.float_]) -> float:
